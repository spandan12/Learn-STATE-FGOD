...
_C.SOLVER.STRATEGY = "A"
_C.SOLVER.INIT_POOL= 200
_C.SOLVER.SEL_AL= 200
_C.SOLVER.NUM_AL= 5
_C.SOLVER.INIT_FILE_NAME= "NA.npy"
_C.SOLVER.KL_VAL= 1.0
_C.SOLVER.FSTR= 2
_C.SOLVER.FSVAL= 2
_C.SOLVER.MODELTYPE = "ce"
_C.SOLVER.HYP_A = 1.0
_C.SOLVER.TR_SIGMA = 0.0
_C.SOLVER.USE_VAC_REG = "yes"
_C.SOLVER.EV_ACT = "exp"
_C.SOLVER.LOO= 0

_C.CERTIFY = CfgNode()
_C.CERTIFY.ALPHA = 0.001
_C.CERTIFY.N0 = 100
_C.CERTIFY.N = 10000
_C.CERTIFY.SKIP = 100
_C.CERTIFY.BATCH = 4
_C.CERTIFY.SIGMA = 0.2
_C.CERTIFY.OUTPUT_DIR = "NA_DIR"
_C.CERTIFY.OUTFILE = "NA"
_C.CERTIFY.MAX = 100
_C.CERTIFY.MODEL_LOAD_NAME = "NA"
